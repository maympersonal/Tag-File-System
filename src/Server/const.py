...
PULL_PRED_REPLICA = 3           # Solicitar los datos replicados de un nodo sucesor
...
REPLICATE_PRED2_STORE_TAG = 11   # Replicar el almacenamiento de una etiqueta
REPLICATE_PRED2_APPEND_FILE = 12 # Replicar la asociación de un archivo con una etiqueta
REPLICATE_PRED2_DELETE_TAG = 13  # Replicar la eliminación de una etiqueta
REPLICATE_PRED2_REMOVE_FILE = 14 # Replicar la desasociación de un archivo de una etiqueta

REPLICATE_PRED2_STORE_FILE = 21  # Replicar el almacenamiento de un archivo
REPLICATE_PRED2_APPEND_TAG = 22  # Replicar la asociación de una etiqueta a un archivo
REPLICATE_PRED2_DELETE_FILE = 23 # Replicar la eliminación de un archivo
REPLICATE_PRED2_REMOVE_TAG = 24  # Replicar la eliminación de una etiqueta de un archivo

REPLICATE_PRED2_STORE_BIN = 30   # Replicar el almacenamiento de un archivo binario
REPLICATE_PRED2_DELETE_BIN = 31  # Replicar la eliminación de un archivo binario

# Replicación de datos desde el sucesor
REPLICATE_PRED_STORE_TAG = 111  # Replicar el almacenamiento de una etiqueta
REPLICATE_PRED_APPEND_FILE = 121 # Replicar la asociación de un archivo con una etiqueta
REPLICATE_PRED_DELETE_TAG = 131 # Replicar la eliminación de una etiqueta
REPLICATE_PRED_REMOVE_FILE = 141 # Replicar la desasociación de un archivo de una etiqueta

REPLICATE_PRED_STORE_FILE = 211 # Replicar el almacenamiento de un archivo
REPLICATE_PRED_APPEND_TAG = 221 # Replicar la asociación de una etiqueta a un archivo
REPLICATE_PRED_DELETE_FILE = 231 # Replicar la eliminación de un archivo
REPLICATE_PRED_REMOVE_TAG = 241 # Replicar la eliminación de una etiqueta de un archivo

REPLICATE_PRED_STORE_BIN = 301  # Replicar el almacenamiento de un archivo binario
REPLICATE_PRED_DELETE_BIN = 311 # Replicar la eliminación de un archivo binario

MULTICAST_GROUP = '224.0.0.1'  # Dirección de multicast local

SECRET_KEY = 'Cc{oYj)NZ92F'  # Clave secreta para el cifrado
CLIENT_SECRET_KEY = 'H#@:D6qd4SYv'
